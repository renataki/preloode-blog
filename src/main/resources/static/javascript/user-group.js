        ...
        global.rest(rest, function(response) {
            ...
            if(response.result) {
                ...
                if(response.userGroup.id != null) {
                    ...
                    $scope.withdrawal.count.start.value = library.numeral.initializeSeparator(response.userGroup.withdrawal.count.start, true);
                    $scope.name.value = response.userGroup.name;
                    $scope.sequence.value = response.userGroup.sequence;
                    $scope.status.value = $scope.camelCaseToStandardCase(response.userGroup.status);
                    $scope.transaction.amount.end.value = response.userGroup.transaction.amount.end;
                    $scope.transaction.amount.start.value = response.userGroup.transaction.amount.start;
                    $scope.transaction.count.end.value = response.userGroup.transaction.count.end;
                    $scope.transaction.count.start.value = response.userGroup.transaction.count.start;
                    $scope.withdrawal.amount.end.value = response.userGroup.withdrawal.amount.end;
                    $scope.withdrawal.amount.start.value = response.userGroup.withdrawal.amount.start;
                    $scope.withdrawal.count.end.value = response.userGroup.withdrawal.count.end;
                    $scope.withdrawal.count.start.value = response.userGroup.withdrawal.count.start;
